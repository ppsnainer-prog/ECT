    ...
    `<div class="form-group"><label>Оператор</label>
     ...
     <div class="form-row-2">
       ...
       <div class="form-group"><label>Звонков (+ или −)</label>
         <input type="number" id="fLbCalls" value="0" step="1" min="0">
       </div>
     </div>
     <div class="form-group"><label>Время на работу</label>
       <div class="form-row-2">
         <div>
           <input type="number" id="fLbHours" value="0" min="0" step="1" placeholder="Часы">
           <p class="field-hint">Часы</p>
         </div>
         <div>
           <input type="number" id="fLbMinutes" value="0" min="0" max="59" step="1" placeholder="Минуты">
