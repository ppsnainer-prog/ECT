          ...
          <section class="crm-block">
            ...
            <div class="crm-block-body">
              ${otabotki.length === 0
                ...
                : otabotki.map(item => `
                  <div class="crm-hint crm-hint-otabotka">
                    <div class="crm-hint-title">
                      <span>${escapeHtml(item.title)}</span>
                      <span class="item-actions">
                        <button class="btn-icon" data-action="edit-item" data-sid="${script.id}" data-type="otabotki" data-iid="${item.id}">✏️</button>
                        <button class="btn-icon" data-action="delete-item" data-sid="${script.id}" data-type="otabotki" data-iid="${item.id}">🗑</button>
                      </span>
                    </div>
                    <div class="crm-hint-text">${escapeHtml(item.text)}</div>
                  </div>
                `).join('')
              }
            </div>
          ...
          <section class="crm-block">
            ...
            <div class="crm-block-body">
              ${shtrafy.length === 0
                ...
                : shtrafy.map(item => `
                  <div class="crm-hint crm-hint-shtraf">
                    <div class="crm-hint-title">
                      <span>${escapeHtml(item.title)}</span>
                      <span class="item-actions">
                        <button class="btn-icon" data-action="edit-item" data-sid="${script.id}" data-type="shtrafy" data-iid="${item.id}">✏️</button>
                        <button class="btn-icon" data-action="delete-item" data-sid="${script.id}" data-type="shtrafy" data-iid="${item.id}">🗑</button>
                      </span>
                    </div>
                    <div class="crm-hint-text">${escapeHtml(item.text)}</div>
                  </div>
